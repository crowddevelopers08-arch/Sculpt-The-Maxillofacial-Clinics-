        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-[426px]:py-5 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 max-[426px]:gap-4 gap-8">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-300 max-[426px]:text-[16px] leading-relaxed">
                Bangalore's trusted destination for premium beauty and hair
                treatments. Expert care with proven, lasting results.
              </p>
            ...
            {/* Quick Links */}
            <div className="space-y-6">
              <h4 className="text-xl font-bold max-[426px]:text-[22px] text-white font-sans">
                Quick Links
              </h4>
              <nav className="space-y-3">
                <a
                  href="#about"
                  className="block max-[426px]:text-[16px] text-gray-300 hover:text-primary transition-colors"
                >
                  About Us
                </a>
                <a
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-300 max-[426px]:text-[16px]">
                    315, Sapthagiri 60 Feet, Health Layout, Chandrashekhara
                    Layout, Annapurneshwari Nagar, Bengaluru,
                    <br />
            ...
            {/* Clinic Hours */}
            <div className="space-y-6">
              <h4 className="text-xl max-[426px]:text-[22px] font-bold text-white font-sans">
                Clinic Hours
              </h4>
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-primary font-medium max-[426px]:text-[16px]">
                      10:00 AM - 8:00 PM
                    </p>
                  </div>
                </div>
              ...
              <a href="#contact-section">
                <Button className="w-full max-[426px]:text-[22px] bg-primary hover:bg-primary/90 text-black font-bold">
                  Book Appointment
                </Button>
              </a>
            </div>
          ...
          <div className="flex justify-between">
            ...
            <div className="border-t border-primary/20 mt-12 pt-8 max-[426px]:pt-4 max-[426px]:mt-4 text-center">
              <p className="text-gray-400 max-[470px]:text-[11px] max-[470px]:mb-[50px] max-[426px]:mb-[0px]">
                © 2025 Sculpt The Maxillofacial Clinic. All rights reserved.
              </p>
            </div>
            <div className="border-t border-primary/20 mt-12 pt-8 max-[426px]:pt-4 max-[426px]:mt-4 text-center">
              <p className="text-gray-400 max-[470px]:text-[11px] max-[426px]:mb-[50px]">
                <a href="/privacy-policy">
                  <span className="text-gray-400 max-[426px]:mb-[50px]">
                    Privacy policy
                  </span>
                </a>
              </p>
